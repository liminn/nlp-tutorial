# -*- coding: utf-8 -*-
# https://github.com/wmathor/nlp-tutorial/blob/master/5-1.Transformer/Transformer-Torch.py
...
print(src_vocab_size) # 6

tgt_vocab = {'P' : 0, 'i' : 1, 'want' : 2, 'a' : 3, 'beer' : 4, 'coke' : 5, 'S' : 6, 'E' : 7, '.' : 8}
idx2word = {i: w for i, w in enumerate(tgt_vocab)}
tgt_vocab_size = len(tgt_vocab)
print(tgt_vocab_size)  # 9
...
print(enc_inputs.shape)  # torch.Size([2, 5])
print(dec_inputs.shape)  # torch.Size([2, 6])
print(dec_outputs.shape) # torch.Size([2, 6])
...
# q1: 为什么encoder中传入的是src_vocab_size，而不是src_len
def get_sinusoid_encoding_table(n_position, d_model):
    ...
    # sinusoid_table shape: (n_position,d_model)
...
class Encoder(nn.Module):
    ...
    def forward(self, enc_inputs):
        ...
        enc_outputs = word_emb + pos_emb     # [batch_size, src_len, d_model]
...
class Decoder(nn.Module):
    ...
    def forward(self, dec_inputs, enc_inputs, enc_outputs):
        ...
        # decoder的Masked Multi-Head Attention的输出为q，encoder_outputs的输出为k,v 
...
def greedy_decoder(model, enc_input, start_symbol):
    ...
    for i in range(0, tgt_len):
        ...
        # projected(dec_logits): [batch_size, tgt_len, tgt_vocab_size]
